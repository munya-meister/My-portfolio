...
content_lines = [
    ...
    "0 -24 Td",
    "/F1 10 Tf",
    "(Location: Harare, Zimbabwe) Tj",
    "T*",
    "(Email: munya.munaj@gmail.com) Tj",
    "T*",
    ...
    "0 -24 Td",
    "/F1 10 Tf",
    "(Digital Marketing Specialist | 2026-Present) Tj",
    "T*",
    "(Freelance Web Developer | 2026-Present) Tj",
    "T*",
    "(Creative Media & Branding | 2026-Present) Tj",
    "T*",
    "(Professional Certifications | 2026-2027) Tj",
    "T*",
    ...
    "0 -22 Td",
    "/F1 10 Tf",
    "(LinkedIn: https://www.linkedin.com/in/munyaradzi-mbewe-digital-marketer/) Tj",
    "T*",
